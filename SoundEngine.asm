...
SFX_Fcount = *-SFX_F
 if SFX_Fcount > 256
     echo "Sound Engine Warning: table SFX_F is too large"
 endif
...
SFX_CVcount = *-SFX_CV
 ...
 if SFX_CVcount > 256
     echo "Sound Engine Warning: table SFX_CV is too large"
 endif
 if SFX_CVcount != SFX_Fcount
   echo "Sound Engine Warning: table SFX_F is not the same size as table SFX_CV"
 endif
...
;-------------------------------------------
;See "stella Advanced Programming guide.txt"
;Mark Lesser's Lord of the Rings
;- BRK Subroutine Trick
BrkRoutine:	;added later
